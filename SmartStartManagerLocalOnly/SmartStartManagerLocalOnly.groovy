/**
 * ====================================================
 *  App Name: SmartStart Manager Local Only
 ...
 *
 * Changelog:
 * 0.6.0 (2026-02-19) - disabled metrics tracking to jtp10181.gateway.scarf.sh and moved iconify-icon.min.js from GitHub to live locally on the hub (sidjohn1)
...
@Field static final String APP_NAME = "SmartStart-Manager Local Only"
@Field static final String COMM_LINK = "https://community.hubitat.com/t/smartstart-manager/137492"

definition(
    name: "SmartStart Manager Local Only",
    namespace: "jtp10181",
...
def pageMain() {
    ...
    dynamicPage(name: "pageMain", title:styleSection("SmartStart Manager Local Only"), uninstall: true, install: true) {
        section() {
...
String listTable() {
    ...
    String str = "<script src='/local/SmartStartManagerLocalOnly.js'></script>"
...
String appInfo() {
    return "<span style='font-size:90%;color:#555a5e;font-weight:bold'>SmartStart Manager Local Only v${VERSION}</span>" +
